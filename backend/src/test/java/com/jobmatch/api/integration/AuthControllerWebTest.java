...
class AuthControllerWebTest {
    ...
    void registerReturnsCreatedResponse() throws Exception {
        ...
        com.jobmatch.api.model.entity.User user = com.jobmatch.api.model.entity.User.builder()
                .id(101L)
                .email("new.user@example.com")
                .fullName("New User")
                .role(com.jobmatch.api.model.entity.User.UserRole.JOB_SEEKER)
                .status(com.jobmatch.api.model.entity.User.UserStatus.PENDING_VERIFICATION)
                .build();
    ...
    void loginReturnsTokenPayload() throws Exception {
        ...
        AuthResponse authResponse = new AuthResponse("access-token", "refresh-token", 86400L, userDto);
